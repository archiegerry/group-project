...
USAGE:
python3 dataset_join.py download      FOR DOWNLOADING ALL DATASETS
python3 dataset_join.py join          FOR JOINING ALL DATASETS
python3 dataset_join.py               FOR DOWNLOADING AND JOINING ALL DATASESTS
